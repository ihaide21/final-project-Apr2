...
education.display = function(){
	for (school in education.schools) {
		...
		var formattedtitles=HTMLonlineTitle.replace("%data%", education.onlineCourses[onlineschools].title);
		var formattedonlineschool = HTMLonlineSchool.replace("%data%", education.onlineCourses[onlineschools].school);
		$(".education-entry:last").append(formattedtitles + formattedonlineschool);

	
		//$(".education-entry:last").append(formattedonlineschool);

		var formattedonlinedate = HTMLonlineDates.replace("%data%", education.onlineCourses[onlineschools].date);
		$(".education-entry:last").append(formattedonlinedate);

		var formattedonlineurl = HTMLonlineURL.replace("%data%", education.onlineCourses[onlineschools].url);
